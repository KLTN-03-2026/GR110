...
function PopperDeleteBoard({ isDeleting, board, handleDeleteBoard }) {
              ...
              <Fade {...TransitionProps} timeout={350}>
                ...
                >
                  ...
                  >
                    ...
                    >
                      This action will permanently delete all Board data and
                      cannot be restored.
                    </Typography>
                  </Box>
                  ...
                  <Box sx={{ px: 2, pt: 1.5, pb: 1 }}>
                    ...
                    >
                      Enter the Board name "{boardName}" to confirm deletion
                    </Typography>
                    ...
                    <List dense disablePadding sx={{ mb: 1.5 }}>
                      {[
                        ...
                        {
                          text: 'You will not be able to recover this Board or its contents.',
                          highlight: false
                        }
                      ].map((item, i) => (
                        <ListItem
                    ...
                    <TextField
                      ...
                      sx={(theme) => ({
                        ...
                        '& .MuiOutlinedInput-root': {
                          ...
                          '& fieldset': {
                            borderColor:
                              inputValue && inputValue !== boardName
